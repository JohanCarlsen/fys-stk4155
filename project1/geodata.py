...
reg = Regression(x, y, _terrain[x, y], 'geodata')
ols_p, ols_beta = reg.OLS(20, store_beta=False)
# reg.plot_evolution('OLS')
# ridge_lasso_p, ridge_beta, lasso_beta = reg.ridge_and_lasso(-10, 10, 3, 1000)
# print(reg.OLS_results)
# reg.plot_evolution('ridge', add_zoom=True)
# reg.plot_evolution('lasso')
reg.bias_variance_tradeoff(max_degree=19, n_bootstraps=100) 
